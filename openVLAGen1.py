...
for i in range(500):
    ...
    if(i%10 == 0):
        ...
        if(ret):
            ...
            panda.control_dofs_position([currentPos[0]+action[0], currentPos[1]+action[1], currentPos[2]+action[2], currentPos[3]+action[3], currentPos[4]+action[4], currentPos[5]+action[5], currentPos[6]+action[6], currentPos[7], currentPos[8]])
