...
xArm = scene.add_entity(
    gs.morphs.MJCF(file='./genesis/mujoco_menagerie/ufactory_xarm7/xarm7.xml', pos = (0, 0, 0.12),),
    vis_mode=gs.morphs.VisMode.MESH,
)
...
xArm.set_dofs_force_range(lower, upper, dofs_idx)
...
# )
# xArm.set_dofs_force_range(
#     np.array([-50, -50, -30, -30, -30, -20, -20, -50]),
#     np.array([50, 50, 30, 30, 30, 20, 20, 50]),
# )

# get the end-effector link
end_effector = xArm.get_link('xarm_gripper_base_link')

# starting position
qpos = xArm.inverse_kinematics(
    link = end_effector,
...
xArm.control_dofs_position(qpos[:-6], motors_dof)
